...
import static com.neusoft.aclome.nilebeat.service.ActorNamesFactory.tailer;
...
import com.neusoft.aclome.nilebeat.akka.dto.EndPointFailed;
import com.neusoft.aclome.nilebeat.akka.dto.Messages;
import com.neusoft.aclome.nilebeat.akka.dto.NewLineEvent;
import com.neusoft.aclome.nilebeat.configuration.EndpointConfiguration;
import com.neusoft.aclome.nilebeat.configuration.EndpointsConfigurationValidator.EndpointsConfiguration;
import com.neusoft.aclome.nilebeat.configuration.ExportsConfigurationValidator.SingleConfiguration;
import com.neusoft.aclome.nilebeat.guice.GuiceAbstractActor;
import com.neusoft.aclome.nilebeat.service.Endpoint;
import com.neusoft.aclome.westworld.tsp.api.OnlineLoggerProcessAPI;
...
public class ManagerActor extends GuiceAbstractActor {	
	...
	private final static OnlineLoggerProcessAPI process = new OnlineLoggerProcessAPI();
	...
	public Receive createReceive() {
		return receiveBuilder()
			...
			.match(NewLineEvent.class, l -> {				
				process.process(l.getContent_s()).forEach(j -> {
						JsonObject json = new JsonParser().parse(new Gson().toJson(l)).getAsJsonObject();
